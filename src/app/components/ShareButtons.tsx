...
export function ShareButtons({ story, chapterNumber }: ShareButtonsProps) {
  // Generate URL for this story/chapter
  const baseUrl = typeof window !== 'undefined' ? window.location.origin : 'https://orangetomato.site';
  const url = chapterNumber 
    ? `${baseUrl}/story/${story.id}/chapter/${chapterNumber}`
